export const projects = [
...

  {
    ...
    tech: ["React", "Next.js", "TypeScript"],
    bullets: [
      "Designed and implemented a production ready landing page for our company.",
    ],
  },
  {
    title: "Fundervest",
    color: "#86EFAC",
    subtitle: "Startup Investment Platform",
    description: "Web Application",
    tech: ["React", "Next.js", "TypeScript"],
    bullets: [
      "Designed and implemented a production ready web application for investors to track new established startups.",
